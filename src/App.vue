...
export default {
  ...
  methods: {
    add() {
      ...
      setInterval(async () => {
        const f = await fetch(`https://min-api.cryptocompare.com/data/price?fsym=${currentTicker.name}&tsyms=USD&api_key=70935e946b15d173df9f2678f65c37aad7fd0aef88d3399ef6f7a8d650ed42e4`);
